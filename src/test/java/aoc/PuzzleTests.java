...
public class PuzzleTests {
	...
	@Test
	public void day11() {
		Puzzle puzzle = new Day11(Utils.read("/test11.txt"));

		Assert.assertEquals("10605", puzzle.part1());
		Assert.assertEquals("2713310158", puzzle.part2());
	}

	@Test
	public void day12() {
		Puzzle puzzle = new Day12(Utils.read("/test12.txt"));

		Assert.assertEquals("31", puzzle.part1());
		Assert.assertEquals("29", puzzle.part2());
	}

	@Test
	public void day13() {
		Puzzle puzzle = new Day13(Utils.read("/test13.txt"));

		Assert.assertEquals("13", puzzle.part1());
		Assert.assertEquals("140", puzzle.part2());
	}

	@Test
	public void day14() {
		Puzzle puzzle = new Day14(Utils.read("/test14.txt"));
